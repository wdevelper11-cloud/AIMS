...
export default function LoginPage() {
  ...
  async function authenticate(action: "login" | "signup") {
    ...
    try {
      ...
      if (result.error) {
        setMessage({ type: "error", text: action === "login" ? "Sign in was unsuccessful. Check your email and password, then try again." : "Your account could not be created. Check your details or try again shortly." });
        return;
      }
      ...
      setMessage({
        type: "error",
        text: "Authentication is temporarily unavailable. Check your connection and try again.",
      });
    } finally {
      setLoading(null);
    }
